...
import io.ehdev.conrad.app.service.version.model.*;
...
public class VersionService {
    ...
    VersionCommitModel createUnreleasedVersion(@PathVariable("repoId") String repoId,
        ...
        return new VersionCommitModel(buildVersion);
    }
    ...
    VersionCommitModel claimVersion(@PathVariable("repoId") String repoId,
        ...
        return new VersionCommitModel(currentCommit.getCommitId(), currentCommit.getVersion());
    }
    ...
    RepoVersionModel findVersionsForRepo(@PathVariable("repoId") String repoId) {
        ...
        List<VersionCommitModel> collect = commitsForRepo.stream().sorted(REVERSE_ORDER).map(VersionCommitModel::new).collect(Collectors.toList());
