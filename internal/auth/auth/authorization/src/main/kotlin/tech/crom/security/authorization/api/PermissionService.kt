...
interface PermissionService {
    ...
    data class PermissionPair(val userId: Long, val permission: CromPermission) {
        constructor(userId: String, permission: CromPermission) : this(userId.toLong(), permission)
    }
}
