...
class ManagerResourceIntegrationTest extends Specification {
    ...
    def 'test crud'() {
        ...
        projectManager.findProject(project.projectId) == project
        ...
        then:
        repoManager.findRepo(repo1.repoId) == repo1
        ...
        then:
        repoManager.findRepo(repo2.repoId) == repo2
        ...
        then:
        !repoManager.findRepo(repo2.repoId)
