...
public class RepoDetails extends TableImpl<RepoDetailsRecord> {

	private static final long serialVersionUID = -596242725;

	/**
	 * The reference instance of <code>public.repo_details</code>
	 */
	public static final RepoDetails REPO_DETAILS = new RepoDetails();
	 ...
	 */
	public RepoDetails(String alias) {
		this(alias, REPO_DETAILS);
	}

	private RepoDetails(String alias, Table<RepoDetailsRecord> aliased) {
		this(alias, aliased, null);
	}

	private RepoDetails(String alias, Table<RepoDetailsRecord> aliased, Field<?>[] parameters) {
	 ...
	 */
	@Override
	public RepoDetails as(String alias) {
		return new RepoDetails(alias, this);
	}

	/**
	 * Rename this table
	 */
	public RepoDetails rename(String name) {
		return new RepoDetails(name, null);
	}
}
