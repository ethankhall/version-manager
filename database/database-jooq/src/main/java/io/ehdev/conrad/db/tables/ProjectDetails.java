...
public class ProjectDetails extends TableImpl<ProjectDetailsRecord> {

	private static final long serialVersionUID = 418741484;

	/**
	 * The reference instance of <code>public.project_details</code>
	 */
	public static final ProjectDetails PROJECT_DETAILS = new ProjectDetails();
	 ...
	 */
	public ProjectDetails(String alias) {
		this(alias, PROJECT_DETAILS);
	}

	private ProjectDetails(String alias, Table<ProjectDetailsRecord> aliased) {
		this(alias, aliased, null);
	}

	private ProjectDetails(String alias, Table<ProjectDetailsRecord> aliased, Field<?>[] parameters) {
	 ...
	 */
	@Override
	public ProjectDetails as(String alias) {
		return new ProjectDetails(alias, this);
	}

	/**
	 * Rename this table
	 */
	public ProjectDetails rename(String name) {
		return new ProjectDetails(name, null);
	}
}
