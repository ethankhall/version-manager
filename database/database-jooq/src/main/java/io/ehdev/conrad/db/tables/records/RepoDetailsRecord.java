...
public class RepoDetailsRecord extends UpdatableRecordImpl<RepoDetailsRecord> implements Record7<UUID, String, String, UUID, UUID, String, String> {
	...
	private static final long serialVersionUID = -1956842795;
	...
	public Field<UUID> field1() {
		return RepoDetails.REPO_DETAILS.UUID;
	}
	...
	public Field<String> field2() {
		return RepoDetails.REPO_DETAILS.REPO_NAME;
	}
	...
	public Field<String> field3() {
		return RepoDetails.REPO_DETAILS.PROJECT_NAME;
	}
	...
	public Field<UUID> field4() {
		return RepoDetails.REPO_DETAILS.PROJECT_UUID;
	}
	...
	public Field<UUID> field5() {
		return RepoDetails.REPO_DETAILS.VERSION_BUMPER_UUID;
	}
	...
	public Field<String> field6() {
		return RepoDetails.REPO_DETAILS.URL;
	}
	...
	public Field<String> field7() {
		return RepoDetails.REPO_DETAILS.DESCRIPTION;
	}
	...
	public RepoDetailsRecord() {
		super(RepoDetails.REPO_DETAILS);
	}

	/**
	 * Create a detached, initialised RepoDetailsRecord
	 */
	public RepoDetailsRecord(UUID uuid, String repoName, String projectName, UUID projectUuid, UUID versionBumperUuid, String url, String description) {
		super(RepoDetails.REPO_DETAILS);

		setValue(0, uuid);
		setValue(1, repoName);
		setValue(2, projectName);
