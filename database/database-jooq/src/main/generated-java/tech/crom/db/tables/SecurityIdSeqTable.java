...
public class SecurityIdSeqTable extends TableImpl<SecurityIdSeqRecord> {
    ...
    private static final long serialVersionUID = 1113623574;
     ...
     */
    public final TableField<SecurityIdSeqRecord, Long> SECURITY_ID = createField("security_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>version_manager_test.security_id_seq.type</code>.
     */
    public final TableField<SecurityIdSeqRecord, String> TYPE = createField("type", org.jooq.impl.SQLDataType.VARCHAR(10), this, "");

    /**
     * Create a <code>version_manager_test.security_id_seq</code> table reference
     */
    public SecurityIdSeqTable() {
        this(DSL.name("security_id_seq"), null);
    }
    ...
    public SecurityIdSeqTable(String alias) {
        this(DSL.name(alias), SECURITY_ID_SEQ);
    }

    /**
     * Create an aliased <code>version_manager_test.security_id_seq</code> table reference
     */
    public SecurityIdSeqTable(Name alias) {
        this(alias, SECURITY_ID_SEQ);
    }

    private SecurityIdSeqTable(Name alias, Table<SecurityIdSeqRecord> aliased) {
        this(alias, aliased, null);
    }

    private SecurityIdSeqTable(Name alias, Table<SecurityIdSeqRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""));
    }

    public <O extends Record> SecurityIdSeqTable(Table<O> child, ForeignKey<O, SecurityIdSeqRecord> key) {
        super(child, key, SECURITY_ID_SEQ);
    }
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SECURITY_ID_SEQ_PRIMARY);
    }
    ...
    public SecurityIdSeqTable as(String alias) {
        return new SecurityIdSeqTable(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public SecurityIdSeqTable as(Name alias) {
    ...
    public SecurityIdSeqTable rename(String name) {
        return new SecurityIdSeqTable(DSL.name(name), null);
    }
     ...
     */
    @Override
    public SecurityIdSeqTable rename(Name name) {
