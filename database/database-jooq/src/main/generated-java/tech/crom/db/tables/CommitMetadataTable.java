...
public class CommitMetadataTable extends TableImpl<CommitMetadataRecord> {
    ...
    private static final long serialVersionUID = -20381078;
     ...
     */
    public final TableField<CommitMetadataRecord, Long> COMMIT_METADATA_ID = createField("commit_metadata_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<CommitMetadataRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(128).nullable(false), this, "");
     ...
     */
    public final TableField<CommitMetadataRecord, String> CONTENT_TYPE = createField("content_type", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>version_manager_test.commit_metadata.created_at</code>.
     */
    public final TableField<CommitMetadataRecord, Instant> CREATED_AT = createField("created_at", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP(6)", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "", new TimestampConverter());

    /**
     * The column <code>version_manager_test.commit_metadata.updated_at</code>.
     */
    public final TableField<CommitMetadataRecord, Instant> UPDATED_AT = createField("updated_at", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP(6)", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "", new TimestampConverter());

    /**
     * Create a <code>version_manager_test.commit_metadata</code> table reference
     */
    public CommitMetadataTable() {
        this(DSL.name("commit_metadata"), null);
    }
    ...
    public CommitMetadataTable(String alias) {
        this(DSL.name(alias), COMMIT_METADATA);
    }

    /**
     * Create an aliased <code>version_manager_test.commit_metadata</code> table reference
     */
    public CommitMetadataTable(Name alias) {
        this(alias, COMMIT_METADATA);
    }

    private CommitMetadataTable(Name alias, Table<CommitMetadataRecord> aliased) {
        this(alias, aliased, null);
    }

    private CommitMetadataTable(Name alias, Table<CommitMetadataRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""));
    }

    public <O extends Record> CommitMetadataTable(Table<O> child, ForeignKey<O, CommitMetadataRecord> key) {
        super(child, key, COMMIT_METADATA);
    }
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.COMMIT_METADATA_COMMIT_ID, Indexes.COMMIT_METADATA_PRIMARY, Indexes.COMMIT_METADATA_PROJECT_ID, Indexes.COMMIT_METADATA_REPO_ID);
    }
    ...
    public CommitDetailsTable commitDetails() {
        return new CommitDetailsTable(this, Keys.COMMIT_METADATA_IBFK_1);
    }

    public ProjectDetailsTable projectDetails() {
        return new ProjectDetailsTable(this, Keys.COMMIT_METADATA_IBFK_2);
    }

    public RepoDetailsTable repoDetails() {
        return new RepoDetailsTable(this, Keys.COMMIT_METADATA_IBFK_3);
    }
    ...
    public CommitMetadataTable as(String alias) {
        return new CommitMetadataTable(DSL.name(alias), this);
    }
     ...
     */
    @Override
    public CommitMetadataTable as(Name alias) {
    ...
    public CommitMetadataTable rename(String name) {
        return new CommitMetadataTable(DSL.name(name), null);
    }
     ...
     */
    @Override
    public CommitMetadataTable rename(Name name) {
