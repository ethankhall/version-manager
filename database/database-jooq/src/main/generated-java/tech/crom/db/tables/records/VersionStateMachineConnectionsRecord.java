...
@Table(name = "version_state_machine_connections", schema = "version_manager_test", uniqueConstraints = {
    ...
    @Index(name = "destination", columnList = "destination ASC"),
    @Index(name = "PRIMARY", unique = true, columnList = "state_machine_detail_id ASC"),
    @Index(name = "source", unique = true, columnList = "source ASC, destination ASC"),
    @Index(name = "version_state_machine_id", columnList = "version_state_machine_id ASC")
})
public class VersionStateMachineConnectionsRecord extends UpdatableRecordImpl<VersionStateMachineConnectionsRecord> implements Record4<Long, Long, Long, Long> {
    ...
    private static final long serialVersionUID = -1194993291;
