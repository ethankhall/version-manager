...
@Entity
@Table(name = "repo_details", schema = "version_manager_test", indexes = {
    @Index(name = "PRIMARY", unique = true, columnList = "repo_detail_id ASC"),
    @Index(name = "project_id", columnList = "project_id ASC"),
    @Index(name = "security_id", columnList = "security_id ASC"),
    @Index(name = "version_bumper_id", columnList = "version_bumper_id ASC")
})
public class RepoDetailsRecord extends UpdatableRecordImpl<RepoDetailsRecord> implements Record8<Long, String, Long, Long, String, String, Boolean, Long> {
    ...
    private static final long serialVersionUID = 1859044977;
