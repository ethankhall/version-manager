...
@Entity
@Table(name = "commit_details", schema = "version_manager_test", indexes = {
    @Index(name = "commit_id_state_idx", columnList = "commit_detail_id ASC, state ASC"),
    @Index(name = "parent_commit_id", columnList = "parent_commit_id ASC"),
    @Index(name = "PRIMARY", unique = true, columnList = "commit_detail_id ASC"),
    @Index(name = "repo_id_state_idx", columnList = "repo_detail_id ASC, state ASC")
})
public class CommitDetailsRecord extends UpdatableRecordImpl<CommitDetailsRecord> implements Record7<Long, Long, Long, String, String, Instant, String> {
    ...
    private static final long serialVersionUID = -286888916;
