...
public class UserPermissionsTable extends TableImpl<UserPermissionsRecord> {
	 ...
	 */
	public final TableField<UserPermissionsRecord, UUID> UUID = createField("uuid", org.jooq.impl.SQLDataType.UUID.nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>public.user_permissions.project_name</code>.
	 */
	public final TableField<UserPermissionsRecord, String> PROJECT_NAME = createField("project_name", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");
