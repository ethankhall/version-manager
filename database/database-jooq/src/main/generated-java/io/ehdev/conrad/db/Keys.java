...
public class Keys {
	...
	private static class UniqueKeys0 extends AbstractKeys {
		...
		public static final UniqueKey<TokenAuthenticationsRecord> TOKEN_AUTHENTICATIONS_PKEY = createUniqueKey(TokenAuthenticationsTable.TOKEN_AUTHENTICATIONS, TokenAuthenticationsTable.TOKEN_AUTHENTICATIONS.UUID);
		public static final UniqueKey<TokenJoinRecord> TOKEN_JOIN_PKEY = createUniqueKey(TokenJoinTable.TOKEN_JOIN, TokenJoinTable.TOKEN_JOIN.UUID);
		public static final UniqueKey<TokenJoinRecord> TOKEN_JOIN_TOKEN_KEY = createUniqueKey(TokenJoinTable.TOKEN_JOIN, TokenJoinTable.TOKEN_JOIN.TOKEN);
	...
	private static class ForeignKeys0 extends AbstractKeys {
		...
		public static final ForeignKey<TokenJoinRecord, TokenAuthenticationsRecord> TOKEN_JOIN__TOKEN_JOIN_TOKEN_FKEY = createForeignKey(io.ehdev.conrad.db.Keys.TOKEN_AUTHENTICATIONS_PKEY, TokenJoinTable.TOKEN_JOIN, TokenJoinTable.TOKEN_JOIN.TOKEN);
		public static final ForeignKey<TokenJoinRecord, ProjectDetailsRecord> TOKEN_JOIN__TOKEN_JOIN_PROJECT_UUID_FKEY = createForeignKey(io.ehdev.conrad.db.Keys.PROJECT_DETAILS_PKEY, TokenJoinTable.TOKEN_JOIN, TokenJoinTable.TOKEN_JOIN.PROJECT_UUID);
		public static final ForeignKey<TokenJoinRecord, RepoDetailsRecord> TOKEN_JOIN__TOKEN_JOIN_REPO_UUID_FKEY = createForeignKey(io.ehdev.conrad.db.Keys.REPO_DETAILS_PKEY, TokenJoinTable.TOKEN_JOIN, TokenJoinTable.TOKEN_JOIN.REPO_UUID);
		public static final ForeignKey<TokenJoinRecord, UserDetailsRecord> TOKEN_JOIN__TOKEN_JOIN_USER_UUID_FKEY = createForeignKey(io.ehdev.conrad.db.Keys.USER_DETAILS_PKEY, TokenJoinTable.TOKEN_JOIN, TokenJoinTable.TOKEN_JOIN.USER_UUID);
